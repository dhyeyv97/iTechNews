...
//     document.getElementById("headMain").innerHTML = ` <h3 id="headMain" class="headline-1">Top General News by <span class="badge bg-img-fluidsecondary ba-clr"> iTechNews</span></h3>`
//     let gen1 = fetch(generalNews)
//     gen1.then((response) => {
...
function displayNews() {
    ...
    document.getElementById("headMain").innerHTML = ` <h3 id="headMain" class="headline-1">Top General News by <span class="badge bg-secondary ba-clr">iTechNews</span></h3>`
    let gen1 = fetch(generalNews)
    gen1.then((response) => {
        return response.json()
    }).then((response) => {
