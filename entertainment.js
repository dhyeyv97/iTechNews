...
function displayNews() {
        ...
        document.getElementById("headMain").innerHTML = ` <h3 id="headMain" class="headline-1">Top Entertainment News by <span class="badge bg-secondary ba-clr"> iTechNews</span></h3>`
    
        let ent1 = fetch(entertainmentNews)
        ent1.then((response) => {
            return response.json()
        }).then((response) => {
            AllData = response.articles;
