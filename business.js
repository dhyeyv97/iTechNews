...
function displayNews() {
    ...
    document.getElementById("headMain").innerHTML = ` <h3 id="headMain" class="headline-1">Top Business News by <span class="badge bg-secondary ba-clr"> iTechNews</span></h3>`
    let gen1 = fetch(businessNews)
    gen1.then((response) => {
        return response.json()
    }).then((response) => {
        AllData = response.articles;
